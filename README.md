# $\LaTeX\textit{--шаблон}$ для отчётов о лабораторных и семинарских работах
...
- `images/` $\text{---}$ статичные изображения (логотип, скриншоты, фото)
- `figures/` $\text{---}$ графики и схемы (желательно в формате PNG или PDF)
...
|---|---|
| xelatex $\times$ 2 | По умолчанию $\text{---}$ два прохода для корректного оглавления и ссылок |
