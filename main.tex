...
% Улучшения для оглавлений/закладок PDF
\usepackage{bookmark}
...
% Пакет для создания графиков (управляется флагом \ifplots в config.tex)
\ifplots
    \usepackage{pgfplots}
...
% Пакеты для листинга кода (управляется флагом \iflisting в config.tex)
\iflisting
    \usepackage{listings}
    \usepackage{xcolor}
\fi
